 ...
 ****************************************************************************/
 (function () {
    ...
    _ccsg.NvgNode.CanvasRenderCmd = function(renderableObject){
    ...
    _ccsg.NvgNode.CanvasRenderCmd.prototype = Object.create(_ccsg.Node.CanvasRenderCmd.prototype);
    _ccsg.NvgNode.CanvasRenderCmd.prototype.constructor = _ccsg.NvgNode.CanvasRenderCmd;
    cc.js.mixin( _ccsg.NvgNode.CanvasRenderCmd.prototype, {
        rendering: function (ctx, scaleX, scaleY) {
            ...
            if(typeof(node.drawFunc)==="function"){
